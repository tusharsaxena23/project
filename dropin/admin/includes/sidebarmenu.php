						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
									 ...
									 <li id="menu-academico" ><a href="create-item.php"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Add New</span> <div class="clearfix"></div></a>
										  
										</li>
										
										 <li><a href="manageissues.php"><i class="fa fa-table"></i>  <span>Delete Item</span><div class="clearfix"></div></a></li>
									<li><a href="manage.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>See Items List</span><div class="clearfix"></div></a></li>
